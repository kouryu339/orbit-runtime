...
fn forwarded_runtime_event_types() -> [&'static str; 6] {
    [
...
mod tests {
    ...
    #[test]
    fn forwards_workflow_studio_draft_update_to_internal_event_log() {
        assert!(forwarded_runtime_event_types()
            .contains(&ai_assistant::events::types::WORKFLOW_STUDIO_DRAFT_UPDATE));
    }
