...
#[define_operation(
    ...
    display_name = "Create Background Agent Task",
    category = "Agent Collaboration",
    system_only,
...
#[define_operation(
    ...
    display_name = "Report Agent Task",
    category = "Agent Collaboration",
    system_only,
