...
pub mod types {
    ...
    /// Workflow Studio editor tool compiled a complete draft for the frontend
    /// to apply. The browser-owned BlueprintJson remains the source of truth.
    pub const WORKFLOW_STUDIO_DRAFT_UPDATE: &str = "workflow_studio:draft_update";
