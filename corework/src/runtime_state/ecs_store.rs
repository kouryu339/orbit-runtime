...
pub struct EcsRuntimeStateStore {
    inner: MapRuntimeStateStore,
    ecs: Arc<EcsWorld>,
}

impl EcsRuntimeStateStore {
...
impl RuntimeStateStore for EcsRuntimeStateStore {
    fn backend_kind(&self) -> RuntimeStateBackendKind {
        RuntimeStateBackendKind::Ecs
    }
...
impl EventStateStore for EcsRuntimeStateStore {
...
impl SharedComponentStateStore for EcsRuntimeStateStore {
