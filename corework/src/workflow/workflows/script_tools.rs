...
#[define_operation(
    name = "readWorkflow",
    description = "Read a persisted *.workflow.json and return its workflow script text in to_ai.",
    system_only,
    params {
        file_name: "String@Exact file name under workflows_dir. Must end with .workflow.json and must not contain a path."
    },
    outputs {
...
#[define_operation(
    ...
    description = "Compile the current Workflow Studio draft, or a persisted workflow selected by exact file_name, without saving.",
    system_only,
    params {
        file_name: "String@Exact file name under workflows_dir. Optional; omit to compile the current Studio draft."
    },
    outputs {
...
#[define_operation(
    name = "testWorkflow",
    description = "Test the current Workflow Studio draft, or a persisted workflow selected by exact file_name, with optional trace. Workflow inputs must use --input.<name>.",
    system_only,
    params {
        file_name: "String@Exact file name under workflows_dir. Optional; omit to test the current Studio draft.",
        trace: "bool@Optional. Include structured trace in result when true.",
