...
export class AgentRuntimePlanCard extends LitElement {
  ...
  declare plan: ExecutionPlan | undefined;
  ...
  protected override render() {
    ...
    return html`<details .open=${this.expanded} @toggle=${(event: Event) => {
...
if (!customElements.get('agent-runtime-plan-card')) customElements.define('agent-runtime-plan-card', AgentRuntimePlanCard);
