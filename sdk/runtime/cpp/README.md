...
This header targets Orbit Runtime native release `v0.5.0-beta.1` / ABI 1.3. Download the
platform package from:

```text
https://github.com/kouryu339/orbit-runtime/releases/tag/v0.5.0-beta.1
```
