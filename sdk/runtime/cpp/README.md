...
This header targets Orbit Runtime native release `v0.4.8-beta.3` / ABI 1.3. Download the
platform package from:

```text
https://github.com/kouryu339/orbit-runtime/releases/tag/v0.4.8-beta.3
```
