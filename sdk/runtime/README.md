...
- send user message;
- pause or close work; pause defaults to `wait_for_tool`, while the explicit
  `detach_tool` mode closes the Runtime wait with an `interrupted_unknown`
  result that requires external verification before retry;
...
|---|---|---|
| Windows x86_64 | `orbit-runtime-runtime-v0.4.8-beta.1-windows-x86_64.zip` | `bin/agent_runtime.dll` |
| Linux x86_64 | `orbit-runtime-runtime-v0.4.8-beta.1-linux-x86_64.zip` | `lib/libagent_runtime.so` |
